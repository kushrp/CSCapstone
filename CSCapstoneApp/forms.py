...
class TeacherForm(forms.Form):
    ...
    university = forms.ChoiceField(label="University(Required)", widget=forms.Select(),
    ...
    def __init__(self, *args, **kwargs):
      ...
      self.fields['university'] = forms.ChoiceField(label='University(Required)', widget=forms.Select(),
                                   choices=tuple((u.id, u.name) for u in University.objects.all()), required=False)
class StudentForm(forms.Form):
    ...
    year = forms.ChoiceField(label='Year(Required)', widget=forms.Select(), required=False, choices=tuple((u, u) for u in grades))
    photo = forms.ImageField(label='Pic', required=False)
    def __init__(self, *args, **kwargs):
...
class EngineerForm(forms.Form):
    company = forms.ChoiceField(label="Company(Required)", widget=forms.Select(),
    ...
    def __init__(self, *args, **kwargs):
      ...
      self.fields['company'] = forms.ChoiceField(label='Company(Required)', widget=forms.Select(),
