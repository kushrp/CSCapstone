...
urlpatterns = [
    ...
    url(r'^group/query$', views.getMyGroups, name="Get My Groups"),
    url(r'^group/add$', views.addMember, name="Add Member in Groups"),
    url(r'^group/delete$', views.deleteGroup, name="Delete Group"),
