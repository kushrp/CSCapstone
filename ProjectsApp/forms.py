...
class ProjectForm(forms.Form):
  ...
  created_at = forms.DateTimeField(label="Date created at", widget=forms.DateTimeInput)
  updated_at = forms.DateTimeField(label="Date updated at", widget=forms.DateTimeInput)
