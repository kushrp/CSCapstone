...
class MyUserManager(BaseUserManager):
  ...
  def create_superuser(self, email=None, password=None, first_name=None, last_name=None, is_student=None,
                       is_professor=None, is_engineer=None):
  ...
  def create_student(self, email=None, password=None, first_name=None, last_name=None):
    return self.create_user(email, password=password, first_name=first_name, last_name=last_name, is_student=True,
                            is_professor=False, is_engineer=False)
